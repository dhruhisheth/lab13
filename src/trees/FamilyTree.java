...
public class FamilyTree
{
    ...
    private static class TreeNode
    {
        ...
        TreeNode getNodeWithName(String targetName)
        {
            ...
            {
                TreeNode result= child.getNodeWithName(targetName);// If child.getNodeWithName(targetName) returns a non-null node,
                if (result!=null)
                	return result;// then that's the node we're looking for. Return it.
            }
